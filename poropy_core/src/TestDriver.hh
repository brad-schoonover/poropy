 ...
 *
 *  This was borrowed from the Detran project.
 */
//---------------------------------------------------------------------------//

#ifndef POROPY_TESTDRIVER_HH_
#define POROPY_TESTDRIVER_HH_
...
/**
 *  \namespace poropy_test
 *  @brief Includes all functionality for performing tests using the
 *         poropy unit test framework.
 */
namespace poropy_test
{
...
public:
  ...
  static size_t d_number_tests;
  static size_t d_number_fails;
  static size_t d_test;

};

size_t TestDriver::d_number_tests = 0;
size_t TestDriver::d_number_fails = 0;
size_t TestDriver::d_test = 0;

} // end namespace poropy_test
