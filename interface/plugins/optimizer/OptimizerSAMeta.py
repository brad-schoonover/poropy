...
import plugin
from poropy.coretools.optimizer_sa import OptimizerSA
import sys


class OptimizerSAMeta(plugin.Plugin):
    """  Defines metadata for OptimizerSA
    """
    ...
    def description(self):
        return """Optimize a loading pattern for a given objective using simulated annealing."""
    ...
    def execute(self):
        ...
        opt = OptimizerSA(argv,reactor,objective)
